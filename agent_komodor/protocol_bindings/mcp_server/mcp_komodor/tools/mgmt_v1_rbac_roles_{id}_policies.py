...
async def rbacrolepoliciescontrollerv1_get(path_id: str) -> Dict[str, Any]:
    ...
    Args:
        path_id (str): The identifier for the RBAC role whose policies are to be retrieved.

    Returns:
        Dict[str, Any]: The JSON response containing the policies associated with the specified RBAC role.
        ...
        get:
          ...
          parameters:
            - name: path_id
              in: path
              required: true
              description: The identifier for the RBAC role.
              schema:
                type: string
          responses:
            '200':
            ...
            '404':
              description: RBAC role not found.
            '500':
    ...
    success, response = await make_api_request(
        "/mgmt/v1/rbac/roles/{path_id}/policies",
        method="GET",
        params=params,
        data=data
    )
