...
async def get_api_v2_users_effective_permissions(param_id: str = None, param_email: str = None) -> Dict[str, Any]:
    ...
    Args:
        param_id (str, optional): The user ID to retrieve permissions for. Defaults to None.
        param_email (str, optional): The user email to retrieve permissions for. Defaults to None.
    ...
    OpenAPI Specification:
        get:
          ...
          description: Retrieve user's effective permissions by either user ID or email.
          parameters:
            - name: id
              in: query
              required: false
              description: The user ID to retrieve permissions for.
              schema:
                type: string
            - name: email
              in: query
              required: false
              description: The user email to retrieve permissions for.
              schema:
                type: string
          responses:
            '200':
