...
async def get_api_v2_realtime_monitors_config_id(path_id: str) -> Dict[str, Any]:
    ...
    success, response = await make_api_request(
        "/api/v2/realtime-monitors/config/{path_id}",
        method="GET",
        params=params,
        data=data
    )
...
async def put_api_v2_realtime_monitors_config_id(path_id: str, body_sensors: List[str], body_type: str, body_name: str = None, body_sinks: Dict[str, Any] = None, body_active: bool = None, body_variables: Dict[str, Any] = None, body_sinksOptions: Dict[str, Any] = None) -> Dict[str, Any]:
    '''
    Updates the configuration of a realtime monitor by its ID.
    ...
    Args:
        ...
        body_sinks (Dict[str, Any], optional): Sinks associated with the monitor. Defaults to None.
    ...
    OpenAPI Specification:
        put:
          summary: Updates the configuration of a realtime monitor by its ID.
...
async def delete_api_v2_realtime_monitors_config_id(path_id: str) -> Dict[str, Any]:
    ...
    OpenAPI Specification:
      delete:
        summary: Deletes a real-time monitor configuration by its ID.
        operationId: deleteApiV2RealtimeMonitorsConfigId
        parameters:
          - name: path_id
            in: path
            required: true
            description: The ID of the real-time monitor configuration to delete.
            schema:
              type: string
        responses:
          '200':
            description: Successful deletion of the real-time monitor configuration.
            content:
              application/json:
                schema:
                  type: object
                  properties:
                    status:
                      ...
                      example: "success"
          '404':
            description: Real-time monitor configuration not found.
            content:
              application/json:
                schema:
                  type: object
